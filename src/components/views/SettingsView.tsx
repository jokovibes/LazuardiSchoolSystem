      ...
      {activeTab === 'system' && (
        <div className="space-y-6">        
          ...
          <form onSubmit={handleSubmitSystem} className="space-y-6">
            ...
            {/* Section 3: AI Face Recognition Sensitivity */}
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
              <h3 className="font-bold text-slate-800 text-base flex items-center gap-2">
                <Sliders className="w-5 h-5 text-indigo-600" />
                3. Tingkat Sensitivitas Sensor AI Face Recognition
              </h3>

              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className="text-xs font-semibold text-slate-700">Ambang Batas Minim Pencocokan Wajah (Confidence Threshold)</label>
                  <span className="text-sm font-black text-indigo-600">{formData.faceConfidenceThreshold}% Match</span>
                </div>
                <input
                  type="range"
                  min="70"
                ...
                <p className="text-[11px] text-slate-500 mt-1">
                  Rekomendasi standar operasional sekolah: 85% - 90% untuk keseimbangan akurasi tinggi dan kecepatan pencocokan.
                </p>
              </div>
            </div>
